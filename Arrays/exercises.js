/* Task 1:  Write an array of months in a year. Using console.log display June, October and January
from the array.

var a = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'];

console.log(a[7], a[9], a[0]); */
...
/*Task 4: Print all elements with indices divisible by 3 from the array [5, 15, -5, 20, 12, 18,
72, 14, 9].
 var a=[5, 15, -5, 20, 12, 18, 72, 14, 9]; 
 console.log(a[1], a[4], a[5], a[6], a[8]); */

/*Task 5: What is the index of number 24 in the following array?
